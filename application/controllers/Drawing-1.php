...
class Drawing extends CI_Controller
{
    ...
    public function tambah($no_ord)
    {
        ...
        redirect('order/dokumen/' . $encrypt_no_order);
    }
    // //////////////////////////////////////////////////// tambah dokumen drawing  /////////////////////////////////////////////////////
    ...
    public function revisi($kode_unik, $no_order)
    {
        ...
        $this->db->join('distribusi_dokumen', 'distribusi_dokumen.id_dd = dokumen_drawing.id_dd', 'left');
        ...
        if ($this->form_validation->run() == false) {
            ...
            // cek jumlah dokumen drawing where no_dokumen dan status valid
            $this->db->select('*');
            $this->db->from('dokumen_drawing');
    ...
    public function hapus($id_dokumen, $no_order, $nama_file)
    {
        ...
        if ($nama_file != '' or $nama_file != NULL) {
            ...
            if (file_exists('assets/file/drawing/' . $nama_file)) {
