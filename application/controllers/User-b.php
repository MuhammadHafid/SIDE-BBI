...
// /////////////////////////////////////////////////////////////// list user ///////////////////////////////////////////////////////////////////
	public function index()
	{
		...
		$this->form_validation->set_rules('password2', 'Repeat Password', 'trim|alpha_numeric|matches[password]');
...
// /////////////////////////////////////////////////////////////// edit user ///////////////////////////////////////////////////////////////////
	public function edit($id_user)
	{
		...
		$this->form_validation->set_rules('nik', 'NIK', 'required|trim');
		$this->form_validation->set_rules('id_role', 'Role', 'required|trim');		
		$this->form_validation->set_rules('password', 'New password', 'trim|alpha_numeric|min_length[6]');
		$this->form_validation->set_rules('password2', 'Repeat password', 'trim|alpha_numeric|matches[password]');
