...
class Role extends CI_Controller
{
	...
	public function dokumen($kode_unik)
	{
		...
		if ($this->form_validation->run() == false) {
			...
			// hapus dan insert ulang pada tabel 'dokumen_akses'
			...
			$this->session->set_flashdata('messageRole', '<div class="alert alert-success" role="alert">Akses Dokumen berhasil diupdate!</div>');
