  ...
  <div class="content-wrapper" style="margin-bottom: 75px;">
      ...
      <section class="content">
          <div class="container-fluid">
              ...
              <form action="<?= base_url('lapprod/edit/') . $laporan['kode_unik'] ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row mb-2">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                          <input required name="nama_dokumen" id="nama_dokumen" class="form-control" type="text" placeholder="Nama Dokumen" value="<?= $laporan['nama_dokumen'] ?>">
                      </div>
                  </div>
                  ...
                  <div class="row mb-2">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                          <input type="text" id="divisi" name="divisi" required="required" class="form-control" value="<?= $laporan['divisi'] ?>">
                      </div>
                  </div>
                  ...
                  <div class="row mb-2">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                          <input type="date" id="tgl_pembuatan" name="tgl_pembuatan" required="required" class="form-control" value="<?= $laporan['tgl_pembuatan'] ?>">
                      </div>
                  </div>
                  ...
                  <div class="row mb-2">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                          <input name="file_laporan" id="file_laporan" class="form-control" type="text" onfocus="(this.type='file')" placeholder="File dokumen">
                      </div>
                  </div>

                  <div class="row mt-2">
                      <div class="col-lg-6 col-md-6 col-sm-12">
                          <button type="submit" name="update" class="btn btn-sm btn-primary btn-block">Edit</button>
                      </div>
                  </div>
