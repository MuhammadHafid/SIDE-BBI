  ...
  <div class="content-wrapper" style="margin-bottom: 75px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1 class="m-0 text-center">Revisi Dokumen CLO</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form action="<?= base_url('clo/revisi/') . $kode_unik . '/' . $no_order . '/' . $fungsi ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <input required name="no_dokumen" id="no_dokumen" class="form-control" type="text" placeholder="No Dokumen" value="<?= $dc['no_dokumen'] ?>" readonly>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <input required name="nama_dokumen" id="nama_dokumen" class="form-control" type="text" placeholder="Nama Dokumen" value="<?= $dc['nama_dokumen'] ?>" readonly>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <select name="status_dokumen" id="status_dokumen" class="form-control" required>
                <option value="<?= $dc['status'] ?>"><?= $dc['nama_status'] ?></option>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <select name="revisi" id="revisi" class="form-control" required>
                <option value="<?= $dc['revisi'] ?>"><?= $dc['nama_revisi'] ?></option>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <select name="edisi" id="edisi" class="form-control" required>
                <option value="<?= $dc['edisi'] ?>"><?= $dc['nama_edisi'] ?></option>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
              <input type="text" class="form-control" value="<?= $dc['total1'] ?>" name="total1" placeholder="0" required>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2">
              <h5 class="text-center">x</h5>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2">
              <input type="text" class="form-control" value="<?= $dc['total2'] ?>" name="total2" placeholder="0" required>
            </div>
          </div>
          <!-- total -->
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <select class="form-control" name="ukuran" id="ukuran">
                <option value="<?= $dc['ukuran'] ?>"><?= $dc['ukuran'] ?></option>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
              <select class="form-control" name="distribusi_dokumen" id="distribusi_dokumen">
                ...
                <option selected value="<?= $dc['id_dd'] ?>"><?= $dc['judul_dokumen'] ?></option>

                <!--                 <?php foreach ($disdok as $disd) : ?>

                  <?php if ($disd['id_dd'] == $dc['id_dd']) : ?>
