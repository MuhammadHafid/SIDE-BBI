  ...
  <div class="content-wrapper" style="margin-bottom: 75px;">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col">
                      <h1 class="m-0 text-center">Revisi Dokumen SPK</h1>
                  </div>
              </div>
          </div>
      </div>
      ...
      <section class="content">
          <div class="container-fluid">
              ...
              <form action="<?= base_url('spk/revisi/') . $kode_unik . '/' . $no_order . '/' . $fungsi ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                          <input required name="file_spk" id="file_spk" class="form-control" type="text" onfocus="(this.type='file')" placeholder="File dokumen" required>
                      </div>
                  </div>
