      ...
      <div class="container-fluid">
        ...
        <div class="row justify-content-end mb-2">
          ...
          <div class="col-lg-1 col-md-1">
            <a data-toggle="tooltip" data-placement="top" title="Export Transmittal" href="<?= base_url('export/transmittal/').$id_transmittal.'/'.$order['id_cc_ord'] ?>" class="btn btn-md btn-success btn-block"><i class="far fa-file-excel"></i></a>
          </div>
        </div>
        <!-- export transmittal -->
                                                            ...
                                                            <tbody>
                                                              ...
                                                              <?php foreach ($dokumen_mrs as $dmr): ?>
                                                                <tr>
                                                                  ...
                                                                  <td style="font-size: 14px;"><?= $dmr['nama_edisi']; ?></td>
                                                                  <td style="font-size: 14px;"><?= $dmr['nama_revisi']; ?></td>
...
<div class="modal fade" id="edrawing" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('transmittal/edrawing/'.$id_transmittal.'/'.$order['id_cc_ord']); ?>" method="post">
              ...
              <tbody>
                ...
                <?php foreach ($edrawing as $ed): ?>
                  <tr>
                    ...
                    <td style="font-size: 14px;"><?= $ed['nama_edisi']; ?></td>
                    <td style="font-size: 14px;"><?= $ed['nama_revisi']; ?></td>
...
<div class="modal fade" id="ebq" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('transmittal/ebq/'.$id_transmittal.'/'.$order['id_cc_ord']); ?>" method="post">
        <div class="modal-body">
          <div class="container-fluid">
              ...
              <tbody>
                ...
                <?php foreach ($ebq as $eb): ?>
                  <tr>
                    ...
                    <td style="font-size: 14px;"><?= $eb['nama_edisi']; ?></td>
                    <td style="font-size: 14px;"><?= $eb['nama_revisi']; ?></td>
...
<div class="modal fade" id="eeis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('transmittal/eeis/'.$id_transmittal.'/'.$order['id_cc_ord']); ?>" method="post">
        <div class="modal-body">
          <div class="container-fluid">
              ...
              <tbody>
                ...
                <?php foreach ($eeis as $ee): ?>
                  <tr>
                    ...
                    <td style="font-size: 14px;"><?= $ee['nama_edisi']; ?></td>
                    <td style="font-size: 14px;"><?= $ee['nama_revisi']; ?></td>
...
<div class="modal fade" id="emp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('transmittal/emp/'.$id_transmittal.'/'.$order['id_cc_ord']); ?>" method="post">
        <div class="modal-body">
          <div class="container-fluid">
              ...
              <tbody>
                ...
                <?php foreach ($emp as $em): ?>
                  <tr>
                    ...
                    <td style="font-size: 14px;"><?= $em['nama_edisi']; ?></td>
                    <td style="font-size: 14px;"><?= $em['nama_revisi']; ?></td>
...
<div class="modal fade" id="eclo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('transmittal/eclo/'.$id_transmittal.'/'.$order['id_cc_ord']); ?>" method="post">
        <div class="modal-body">
          <div class="container-fluid">
              ...
              <tbody>
                ...
                <?php foreach ($eclo as $ec): ?>
                  <tr>
                    ...
                    <td style="font-size: 14px;"><?= $ec['nama_edisi']; ?></td>
                    <td style="font-size: 14px;"><?= $ec['nama_revisi']; ?></td>
...
<div class="modal fade" id="emrs" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('transmittal/emrs/'.$id_transmittal.'/'.$order['id_cc_ord']); ?>" method="post">
        <div class="modal-body">
          <div class="container-fluid">
              ...
              <tbody>
                ...
                <?php foreach ($dokumen_mrs as $dr): ?>
                  <tr>
                    ...
                    <td style="font-size: 14px;"><?= $dr['nama_edisi']; ?></td>
                    <td style="font-size: 14px;"><?= $dr['nama_revisi']; ?></td>
                ...
                <?php foreach ($emrs as $er): ?>
                  <tr>
                    ...
                    <td style="font-size: 14px;"><?= $er['nama_edisi']; ?></td>
                    <td style="font-size: 14px;"><?= $er['nama_revisi']; ?></td>
