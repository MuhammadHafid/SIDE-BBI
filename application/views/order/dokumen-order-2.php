            ...
            <div class="row d-flex justify-content-between mb-2 mt-1">
                <div class="col-lg-2 col-md-2">
                    <select name="forma" class="col-lg-12 col-md-12 col-sm-12 col-xs-4 form-control" onchange="location = this.value;">
                        ...
                        foreach ($role as $r) {
                        ?>
                            <option value="<?= base_url('order/dokumen/') . $order['id_cc_ord'] . '/' . $r['nama_role'] ?>"><?= $r['nama_role'] ?></option>
                        <?php
                        }
                        ?>
                    </select>
                                                        ...
                                                        <?php if ($ds['no_sp'] == NULL) : ?>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    ...
                                                                    <!-- view -->
                                                                    <?php if ($this->session->userdata('id_role') == 1 or $this->session->userdata('id_role') == 5 or $this->session->userdata('id_role') == 14) : ?>
                                                                        <!-- edit -->
